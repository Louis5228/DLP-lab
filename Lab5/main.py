...
if __name__=='__main__':
    ...
    for epoch in range(1, epochs+1):
        ...
        print(f'BLEU socre:{BLEUscore:.4f}  Gaussian score:{Gaussianscore:.4f}') # Gaussian score:{Gaussianscore:.4f}')
        print()
        ...
        if BLEUscore > best_BLEUscore:
            ...
            # save model
            torch.save(best_model_wts, os.path.join('models', f'best_{kl_annealing_type}_time{time}_epochs{epoch}.pt'))
