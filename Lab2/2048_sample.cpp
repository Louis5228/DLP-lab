...
public:
	 ...
	 */
	void update_episode(std::vector<board>& path_s, std::vector<state>& path_ss, float alpha) const {
		// TODO
		float exact = 0;
		float error = 0;
...
int main(int argc, const char* argv[]) {
	...
	tdl.load("/home/louis/DLP-lab/Lab2/weights/train_100000_6.bin");

	// write the episode and scores
	// std::ofstream myfile;
	// myfile.open ("./episode_scores.txt");

	// train the model
	int store_weight = 25000;
	...
	for (size_t n = 1; n <= total; n++) {
		...
		// update by TD(0)
		tdl.update_episode(path_s, path_ss, alpha);
		tdl.make_statistic(n, b, score);
		path_s.clear();
		path_ss.clear();

		// if(n == 25000){
		// 	tdl.save("/home/louis/DLP-lab/Lab2/weights/train_25000_6.bin");
		// }else if (n == 50000){
		// 	tdl.save("/home/louis/DLP-lab/Lab2/weights/train_50000_6.bin");
		// }else if (n == 75000){
		// 	tdl.save("/home/louis/DLP-lab/Lab2/weights/train_75000_6.bin");
		// }
	}

	// store the model into file
	// tdl.save("/home/louis/DLP-lab/Lab2/weights/train_100000_6.bin");
	// myfile.close();
